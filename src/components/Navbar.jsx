...
const Navbar = () => {
  ...
  <>
    ...
    <Link to="/profile" className="text-white font-semibold hover:text-teal-200 transition duration-300">Profile</Link>

    <button onClick={logout} className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-full focus:outline-none focus:ring-2 focus:ring-red-400 transition duration-300">
      Logout
    </button>
  </>
) : (
